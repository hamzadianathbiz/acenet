...
common={'orchestrator.py':root/'harness/orchestrator.py','economy.py':root/'harness/economy.py','permissions.py':root/'connector/permissions.py','model-instructions.md':root/'connector/model-instructions.md','bridge.py':root/'connector/bridge.py','harness.py':root/'harness/harness.py','setup.py':root/'connector/setup.py','local_models.py':root/'connector/local_models.py','local_inference.py':root/'connector/local_inference.py','openrouter_inference.py':root/'connector/openrouter_inference.py'}
